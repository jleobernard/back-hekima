...
public class SourceHandler {
    ...
    public SourceHandler(SourceRepository sourceRepository, ReactiveNeo4jTemplate neo4jTemplate) {
    ...
    public Mono<ServerResponse> search(ServerRequest request) {
        ...
        Flux<HekimaSourceModel> sources = neo4jTemplate.findAll(cypher, parameters, HekimaSourceModel.class);
        return ok().contentType(MediaType.APPLICATION_JSON).body(sources, HekimaSourceModel.class);
    }
}
